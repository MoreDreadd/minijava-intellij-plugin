...
public class MiniJavaExpressionImpl extends ASTWrapperPsiElement implements MiniJavaExpression {

  public MiniJavaExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MiniJavaSumme getSumme() {
    return findNotNullChildByClass(MiniJavaSumme.class);
  }
