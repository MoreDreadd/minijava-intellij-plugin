...
public class MiniJavaVarZuwImpl extends ASTWrapperPsiElement implements MiniJavaVarZuw {

  public MiniJavaVarZuwImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniJavaVisitor visitor) {
    visitor.visitVarZuw(this);
  }
