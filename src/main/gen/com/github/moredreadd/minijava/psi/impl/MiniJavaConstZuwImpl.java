...
public class MiniJavaConstZuwImpl extends ASTWrapperPsiElement implements MiniJavaConstZuw {

  public MiniJavaConstZuwImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniJavaVisitor visitor) {
    visitor.visitConstZuw(this);
  }
